...
class VersionKey8x(Component):
    """Version key for PrestaShop 8.x and 9.x"""

    _name = "_prestashop.version.key.8.x"
    _inherit = "_prestashop.version.key"
    _usage = "prestashop.version.key.8.x"
    ...
    keys = {
        ...
        "order_slip": "order_slip",
        "order_slip_detail": "order_slip_details",
        "order_discounts": "order_cart_rules",  # Changed in PS 8/9
        "order_row": "order_row",  # Keep singular for XML format
        "group": "groups",
        "tax": "taxes",
        "combinations": "combinations",
        "product_features": "product_features",
